...
public interface BasketballMatchLiveDataDao {
    ...
    @Insert("insert into basketball_match_live_data(match_id,status, h_f_quarter, h_s_quarter, h_t_quarter, h_4_quarter, " +
            "a_f_quarter, a_s_quarter, a_t_quarter, a_4_quarter, h_free_throw, h_Num_Pause_Remain, h_Num_Of_Fouls, " +
            "h_Free_Throw_Percentage, h_Total_Pause, h_Two_Goal, h_Three_Goal, a_free_throw, a_Num_Pause_Remain, " +
   ...
   @Update("update basketball_match_live_data set status=#{status}, h_f_quarter=#{hFQuarter},h_s_quarter=#{hSQuarter},h_t_quarter=#{hTQuarter},h_4_quarter=#{h4Quarter}," +
           "a_f_quarter=#{aFQuarter},a_s_quarter=#{aSQuarter},a_t_quarter=#{aTQuarter},a_4_quarter=#{a4Quarter},h_free_throw=#{hFreeThrow},h_Num_Pause_Remain=#{hNumPauseRemain}," +
           "h_Num_Of_Fouls=#{hNumOfFouls},h_Free_Throw_Percentage=#{hFreeThrowPercentage},h_Total_Pause=#{hTotalPause},a_free_throw=#{aFreeThrow},a_Num_Pause_Remain=#{aNumPauseRemain}," +
   ...
   @Select("select match_id,status, h_f_quarter, h_s_quarter, h_t_quarter, h_4_quarter, a_f_quarter, a_s_quarter,a_t_quarter," +
           "a_4_quarter, h_free_throw, h_num_pause_remain, h_num_of_fouls, h_free_throw_percentage, " +
           "h_total_pause, h_two_goal, h_three_goal, a_free_throw, a_num_pause_remain, a_num_offouls, " +
