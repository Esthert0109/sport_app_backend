...
public interface BasketballMatchLiveDataDao {
    ...
    @Insert("insert into basketball_match_live_data(match_id, h_f_quarter, h_s_quarter, h_t_quarter, h_4_quarter, " +
   ...
   @Update("update basketball_match_live_data set h_f_quarter=#{hFQuarter},h_s_quarter=#{hSQuarter},h_t_quarter=#{hTQuarter},h_4_quarter=#{h4Quarter}," +
