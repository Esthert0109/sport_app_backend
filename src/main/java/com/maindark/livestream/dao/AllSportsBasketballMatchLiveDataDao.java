...
public interface AllSportsBasketballMatchLiveDataDao {
    ...
    @Insert("insert into all_sports_basketball_match_live_data(match_id,status,match_time,match_date," +
            "home_team_name,away_team_name,home_team_logo,away_team_logo, h_f_quarter, h_s_quarter, h_t_quarter, h_4_quarter, " +
            ...
            "#{matchId},#{status},#{matchTime},#{matchDate},#{homeTeamName},#{awayTeamName},#{homeTeamLogo},#{awayTeamLogo}," +
            "#{hFQuarter},#{hSQuarter},#{hTQuarter},#{h4Quarter},#{aFQuarter},#{aSQuarter},#{aTQuarter},#{a4Quarter}," +
    ...
    @Update("update all_sports_basketball_match_live_data set status=#{status}, h_f_quarter=#{hFQuarter},h_s_quarter=#{hSQuarter},h_t_quarter=#{hTQuarter},h_4_quarter=#{h4Quarter}," +
    ...
    @Select("select match_id,status as statusStr,match_time,match_date,home_team_name,away_team_name,home_team_logo," +
            "away_team_logo, h_f_quarter, h_s_quarter, h_t_quarter, h_4_quarter, a_f_quarter, a_s_quarter,a_t_quarter," +
            "a_4_quarter, " +
