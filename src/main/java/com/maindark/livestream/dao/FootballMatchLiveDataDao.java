...
public interface FootballMatchLiveDataDao {
    ...
    @Update("update football_match_live_data set status_id=#{statusId},home_attack_num=#{homeAttackNum}" +
            ...
            ",home_shoot_goal_num=#{homeShootGoalNum}," +
            "away_shoot_goal_num=#{awayShootGoalNum}," +
            "home_bias_num=#{homeBiasNum},away_bias_num=#{awayBiasNum},home_corner_kick_num=#{homeCornerKickNum}," +
            "away_corner_kick_num=#{awayCornerKickNum}, " +
