...
public interface AllSportsBasketballMatchDao {
    ...
    @Select("select t.match_id as id,t.competition_name,t.match_time as matchTimeStr," +
            ...
            "t.away_score as away_team_score from all_sports_basketball_match t inner join all_sports_collection co on co.match_id = t.match_id " +
    ...
    @Select("select t.match_id as id,t.competition_name,t.match_time as matchTimeStr," +
            ...
            "from all_sports_basketball_match t inner join all_sports_collection co on co.match_id= t.match_id " +
