...
public interface AllSportsBasketballMatchDao {
    ...
    @Select("select t.match_id as id,t.competition_name,t.match_time as matchTimeStr,t.status as statusStr,t.match_date,t.home_team_name,t.away_team_name,t.home_team_logo,t.away_team_logo,t.status,t.home_score as home_team_score,t.away_score as away_team_score from all_sports_basketball_match t where " +
            "home_team_name like '%${teamName}$' or away_team_name like '%${teamName}%' and t.match_date >= #{from} and t.match_date <#{to} order by t.match_date desc,t.match_time asc limit #{pageSize} offset #{offset}")
    List<BasketballMatchVo> getAllSportsBasketMatchByTeamName(@Param("teamName") String teamName, @Param("from") String from, @Param("to") String to, @Param("pageSize") int pageSize, @Param("offset") long offset);
    @Select("select t.match_id as id,t.competition_name,t.match_time as matchTimeStr,t.status as statusStr,t.match_date,t.home_team_name,t.away_team_name,t.home_team_logo,t.away_team_logo,t.status,t.home_score as home_team_score,t.away_score as away_team_score from all_sports_basketball_match t where  " +
    ...
    FootballMatchVo getAllSportsBasketMatchByMatchId(@Param("matchId")Long matchId);
}
