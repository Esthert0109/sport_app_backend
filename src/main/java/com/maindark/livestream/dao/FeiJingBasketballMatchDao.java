...
public interface FeiJingBasketballMatchDao {
    ...
    @Select("select t.match_id as id,t.competition_name,t.match_time as matchTimeStr,t.status,t.home_team_id,t.away_team_id,t.match_date,t.home_team_cns as home_team_name,t.away_team_cns as away_team_name,t.home_team_logo,t.away_team_logo,t.status,t.home_score as home_team_score,t.away_score as away_team_score from fei_jing_basketball_match t where " +
    ...
    @Select("select t.match_id as id,t.competition_name,t.match_time as matchTimeStr,t.status,t.match_date,t.home_team_cns as home_team_name,t.away_team_cns as away_team_name,t.home_team_logo,t.away_team_logo,t.status,t.home_score as home_team_score,t.away_score as away_team_score from fei_jing_basketball_match t where " +
