...
public interface AllSportsFootballMatchDao {
    ...
    @Insert("insert into all_sports_football_match(id, competition_id, status, match_time, match_date, home_team_id, away_team_id, " +
            "home_team_name, away_team_name, home_team_logo, away_team_logo, home_team_score, away_team_score, home_formation, " +
            "away_formation, referee, venue, event_live, line_up)values (" +
            "#{id},#{competitionId},#{status},#{matchTime},#{matchDate},#{homeTeamId},#{awayTeamId}," +
