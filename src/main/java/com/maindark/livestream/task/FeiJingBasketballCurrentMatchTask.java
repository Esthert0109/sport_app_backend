...
public class FeiJingBasketballCurrentMatchTask {
    ...
    public FeiJingBasketballMatch getFeiJingBasketbllMatch(Map<String,Object> match){
        ...
        feiJingBasketballMatch.setHomeScore((org.apache.commons.lang3.StringUtils.equals("", homeTeamScore) ? 0 : Integer.parseInt(homeTeamScore)));
        feiJingBasketballMatch.setHFQuarter((org.apache.commons.lang3.StringUtils.equals("", homeTeamScore) ? 0 : Integer.parseInt(home1)));
        feiJingBasketballMatch.setHSQuarter((org.apache.commons.lang3.StringUtils.equals("", homeTeamScore) ? 0 : Integer.parseInt(home2)));
        feiJingBasketballMatch.setHTQuarter((org.apache.commons.lang3.StringUtils.equals("", homeTeamScore) ? 0 : Integer.parseInt(home3)));
        feiJingBasketballMatch.setH4Quarter((org.apache.commons.lang3.StringUtils.equals("", homeTeamScore) ? 0 : Integer.parseInt(home4)));
        feiJingBasketballMatch.setAwayScore((org.apache.commons.lang3.StringUtils.equals("", homeTeamScore) ? 0 : Integer.parseInt(awayTeamScore)));
        feiJingBasketballMatch.setAFQuarter((org.apache.commons.lang3.StringUtils.equals("", homeTeamScore) ? 0 : Integer.parseInt(away1)));
        feiJingBasketballMatch.setASQuarter((org.apache.commons.lang3.StringUtils.equals("", homeTeamScore) ? 0 : Integer.parseInt(away2)));
        feiJingBasketballMatch.setATQuarter((org.apache.commons.lang3.StringUtils.equals("", homeTeamScore) ? 0 : Integer.parseInt(away3)));
