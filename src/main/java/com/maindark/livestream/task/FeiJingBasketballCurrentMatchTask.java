...
//        String matchTime = (String) match.get("startTime");
        ...
        feiJingBasketballMatch.setHFQuarter(Integer.parseInt(home1));
        feiJingBasketballMatch.setHTQuarter(Integer.parseInt(home2));
        feiJingBasketballMatch.setHTQuarter(Integer.parseInt(home3));
        feiJingBasketballMatch.setH4Quarter(Integer.parseInt(home4));
        feiJingBasketballMatch.setAwayScore(StringUtils.equals("",homeTeamScore)?0:Integer.parseInt(awayTeamScore));
        feiJingBasketballMatch.setAFQuarter(Integer.parseInt(away1));
        feiJingBasketballMatch.setASQuarter(Integer.parseInt(away2));
        feiJingBasketballMatch.setATQuarter(Integer.parseInt(away3));
        feiJingBasketballMatch.setA4Quarter(Integer.parseInt(away4));
