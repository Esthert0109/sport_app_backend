...
@Slf4j
@EnableScheduling
public class FeiJingBasketballLiveAddressTask {
    @Resource
    ...
    @Scheduled(cron = "0 */1 * * * *")
    public void getBasketballLiveAddress(){
        String url = feiJingConfig.getLiveBasketballAddress();
    ...
    private FeiJingLiveAddress saveStreamData(String matchId, JSONArray streams) {
        ...
        feiJingLiveAddress.setSportId(SportTypeEnum.BASKETBALL.getCode());
